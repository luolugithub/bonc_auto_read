...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--name', type=str, default='bonc', help='name of the experiment. It decides where to store samples and models')
        ...
        # input/output sizes       
        self.parser.add_argument('--batchSize', type=int, default=12, help='input batch size')
        ...
        # for setting inputs
        self.parser.add_argument('--dataroot', type=str, default='./datasets/bonc/')
